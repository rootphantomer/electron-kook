...
class MainController {
  ...
  init() {
    ...
    this.window.loadURL("https://www.kookapp.cn/");
    // this.window.loadURL('https://www.kookapp.cn/app/channels/9019557496487189/7511474327643283')
